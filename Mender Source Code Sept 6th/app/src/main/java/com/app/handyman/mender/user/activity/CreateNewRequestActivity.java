...
public class CreateNewRequestActivity extends AppCompatActivity {
    ...
    private final static String TAG = CreateNewRequestActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (bundle != null) {
            toolbar_title.setText("Edit Job Request");
        ...
        mNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Log.d(TAG, jobTitle + jobDescription + phoneNumber + address + zipcode);

                if (TextUtils.isEmpty(jobTitle)) {
                    Toast.makeText(CreateNewRequestActivity.this, "Please enter job title.", Toast.LENGTH_SHORT).show();
                } else if (TextUtils.isEmpty(jobDescription)) {
                    Toast.makeText(CreateNewRequestActivity.this, "Please enter job description.", Toast.LENGTH_SHORT).show();
                } else if (TextUtils.isEmpty(address)) {
                    Toast.makeText(CreateNewRequestActivity.this, "Please enter job address.", Toast.LENGTH_SHORT).show();
                } else if (TextUtils.isEmpty(zipcode)) {
                    Toast.makeText(CreateNewRequestActivity.this, "Please enter zip code.", Toast.LENGTH_SHORT).show();
                } else if (TextUtils.isEmpty(phoneNumber)) {
                    Toast.makeText(CreateNewRequestActivity.this, "Please enter phone no.", Toast.LENGTH_SHORT).show();
                } else if (phoneNumber.length() < 10||phoneNumber.length()!=10) {
                    Toast.makeText(CreateNewRequestActivity.this, "Please enter valid phone no.", Toast.LENGTH_SHORT).show();
                } else {
