...
public class MyJobDetailsActivity extends AppCompatActivity {

    private static final String TAG = MyJobDetailsActivity.class.getSimpleName();


    private TextView txtJobTitle, txtJobDescription, txtPhoneNumber, txtAddress, txtLocation, txtPhoneNum, jobdes, jobtitle1;
    ...
    private FloatingActionButton menu_item_1, menu_item_2, menu_item_3, menu_item_4;
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                txtMaterialPurchasedValue.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        Intent intent = new Intent(MyJobDetailsActivity.this, AddMaterialPurchaseDetailsActivity.class);
...
//                }
                ...
                menu_item_1.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        String uri = "tel:" + request.getAddress();
                ...
                menu_item_2.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        String uri = "tel:" + request.getPropertyManagerPhoneNumber();
                        Intent intent = new Intent(Intent.ACTION_DIAL);
                        intent.setData(Uri.parse(uri));
                        startActivity(intent);
                    }
                ...
                menu_item_3.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        Calendar cal = Calendar.getInstance();
                        Intent intent = new Intent(Intent.ACTION_EDIT);
                ...
                mRaiseDispute.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent intent = new Intent(MyJobDetailsActivity.this, RaiseDisputeActivity.class);
                ...
                txtAddress.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if (!address.isEmpty()) {
                            ...
                            Toast.makeText(MyJobDetailsActivity.this, "Not able to fetch address!", Toast.LENGTH_SHORT).show();
                        }
                    ...
                    public void onSuccess(Uri uri) {
                        ...
                        try {
                            ...
                            if (finalI == 1) {
                                ...
                                Glide.with(MyJobDetailsActivity.this)
                            ...
                            final ImagePopup imagePopup = new ImagePopup(MyJobDetailsActivity.this);
...
//        toolbar.setTitle("");
        ...
        menu_item_1 = (FloatingActionButton) findViewById(R.id.menu_item_1);
        menu_item_2 = (FloatingActionButton) findViewById(R.id.menu_item_2);
        menu_item_3 = (FloatingActionButton) findViewById(R.id.menu_item_3);
        menu_item_4 = (FloatingActionButton) findViewById(R.id.menu_item_4);

        mImage = (ImageView) findViewById(R.id.image);
        mImage2 = (ImageView) findViewById(image2);
        mImage3 = (ImageView) findViewById(R.id.image3);

        toast = Toast.makeText(MyJobDetailsActivity.this, "", Toast.LENGTH_SHORT);
        ...
        rvMaterialRecipt.setLayoutManager(new LinearLayoutManager(MyJobDetailsActivity.this, LinearLayoutManager.HORIZONTAL, false));
    ...
    private void startJobConfirmation() {
        final Dialog dialog = new Dialog(MyJobDetailsActivity.this);
    ...
    private void goToNextActivity() {
        Intent intent = new Intent(MyJobDetailsActivity.this, StartJobActivity.class);
