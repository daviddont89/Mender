...
public class HomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent().getExtras() == null) {
            ...
            //Toast.makeText(this, "Url : " + id, Toast.LENGTH_SHORT).show();
...
//                                        return true;
                                    ...
                                    case R.id.share:
                                        ...
                                        String strShare = "You should check out the amazing app \'Mender Handyman Services \' ! Download it today from.... "
                                        ...
                                        startActivity(Intent.createChooser(sendIntent, getResources().getString(R.string.share)));
                                            ...
                                            /*Intent sendIntent = new Intent();
                                            //You should check out the amazing app \'Practice Presto\'! Download it today from....
                                            String sAux ="You should check out the amazing app \'Mender Handyman Services \' ! Download it today from.... " + "\n";
                                    ...
                                    case R.id.logout:
                                        ...
                                        final Button mNo = (Button) dialog.findViewById(R.id.cancel);
                                        ...
                                        mNo.setTypeface(myCustomFont19);
